...
const TELEGRAM_HANDLE = 'fakeidplugsource10';
...
export default function WhatsAppWidget() {
  ...
  return (
    <>
      {/* ── Telegram floating button — sits above WhatsApp widget ── */}
      <div className="fixed z-40 right-4" style={{ bottom: isOpen ? '26rem' : '7rem' }}>
        <button
          type="button"
