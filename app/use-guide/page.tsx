...
export const metadata: Metadata = {
  title: 'Fake ID Picture Guide — Photo Rules & Ordering Process | IDCARDSMEN',
  description:
  ...
  openGraph: {
    ...
    url: 'https://idcardsmen.com/use-guide',
    siteName: 'IDCARDSMEN',
    images: [{ url: 'https://idcardsmen.com/images/landinggirl.jpg', width: 1200, height: 630, alt: 'Fake ID Picture Guide - IDCARDSMEN' }],
    type: 'website',
  },
  twitter: {
    ...
    images: ['https://idcardsmen.com/images/landinggirl.jpg'],
  },
  alternates: {
    canonical: 'https://idcardsmen.com/use-guide',
  },
};
