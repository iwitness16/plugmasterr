    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <div className="pt-32 sm:pt-40 lg:pt-48 pb-12 px-4 sm:px-6 lg:px-8 bg-white text-black border-t border-white">
        <div className="max-w-2xl mx-auto">
          ...
          {/* SEO H1 + intro */}
          <h1 className="text-3xl sm:text-4xl font-display font-bold text-black mb-3 text-center">
            Fake ID Reviews — What Our Customers Say
          </h1>
          <p className="text-center text-gray-600 text-sm sm:text-base mb-8">
            Over 15,000 verified <strong>fake ID reviews</strong> from real customers worldwide. 180+ reviews across 36 pages.
            Ready to order? <Link href="/product-list" className="text-yellow-green hover:underline">Browse all fake IDs</Link> or{' '}
            <Link href="/faq" className="text-yellow-green hover:underline">check our FAQ</Link>.
          </p>
            ...
            <div>
              ...
              <div className="space-y-1.5 sm:space-y-2 text-gray-400 text-xs sm:text-sm">
                ...
                <div className="flex space-x-3 mt-4">
                  <a href="https://wa.me/13344468194" className="w-10 h-10 sm:w-12 sm:h-12 bg-green-500 rounded-lg flex items-center justify-center hover:bg-green-600 transition">
