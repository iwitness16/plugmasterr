            ...
            <div>
              ...
              <div className="space-y-1.5 sm:space-y-2 text-gray-400 text-xs sm:text-sm">
                ...
                <div className="flex space-x-3 mt-4">
                  <a href="https://wa.me/13478649962" className="w-10 h-10 sm:w-12 sm:h-12 bg-green-500 rounded-lg flex items-center justify-center hover:bg-green-600 transition">
