...
function OrderPageContent() {
  ...
  // Full image map matching the product list page
  const PRODUCT_IMAGES: Record<string, string> = {
    'Alabama': '/images/alabama.jpg',
    'Arizona': '/images/arizona.jpg',
    'California': '/images/california.jpg',
    'California CM1': '/images/california.jpg',
    'California CDL': '/images/california.jpg',
    'Colorado': '/images/colorado.jpg',
    'Connecticut': '/images/connecticut.jpg',
    'Delaware': '/images/delaware.jpg',
    ...
    'Massachusetts': '/images/massachusetts.jpg',
    'Michigan': '/images/michigan.jpg',
    'Minnesota': '/images/minnesota.jpg',
    'Mississippi': '/images/mississippi.jpg',
    'Missouri': '/images/missouri.jpg',
    'Nebraska': '/images/nebraska.jpg',
    'Nevada': '/images/nevada.jpg',
    'New Jersey': '/images/newjersey.jpg',
    'New York Old Verison': '/images/newyork.jpg',
    'New York CDL': '/images/newyork.jpg',
    'North Carolina': '/images/northcarolina.jpg',
    'Ohio': '/images/ohio.jpg',
    'Ohio CDL': '/images/ohio.jpg',
    'Pennsylvania': '/images/pennsylvania.jpg',
    'Pennsylvania CDL': '/images/pennsylvania.jpg',
    'Rhode Island': '/images/rhodeisland.jpg',
    'South Carolina': '/images/southcarolina.jpg',
    'Tennessee': '/images/tennessee.jpg',
    'Texas': '/images/texas.jpg',
    'Texas CDL': '/images/texas.jpg',
    'Utah': '/images/utah.jpg',
    'Virginia': '/images/virginia.jpg',
    'Washington': '/images/washington.jpg',
    'Wisconsin': '/images/wisconsin.jpg',
    'British Columbia': '/images/british.jpg',
    'Ontario': '/images/ontario.jpg',
    'Quebec': '/images/quebec.jpg',
    'London': '/images/uk.jpg',
    'Newcastle': '/images/uk.jpg',
    'Wales': '/images/uk.jpg',
    'Scotland': '/images/uk.jpg',
    'Northern Ireland': '/images/uk.jpg',
    'Birmingham': '/images/uk.jpg',
    'Manchester': '/images/uk.jpg',
    'Liverpool': '/images/uk.jpg',
    'Leeds': '/images/uk.jpg',
  ...
  useEffect(() => {
    const img = PRODUCT_IMAGES[formData.product];
    setMainProductImage(img || '/images/ordertemp.png');
  }, [formData.product]);
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      if (!formData.socialValue.trim()) {
        throw new Error('Please provide your WhatsApp number (with country code)');
      }
  ...
  const handleFormSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Reuse existing add-to-cart validation and logic, then go to cart page
      await handleAddToCart();
    } catch (error: any) {
      console.error('Error during checkout redirect:', error);
      setSubmitError(error.message || 'Failed to proceed to cart. Please try again.');
    } finally {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <div className="pt-32 sm:pt-40 lg:pt-48 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-2xl sm:text-3xl font-display font-bold text-gray-900 mb-6">
            Order Fake ID Online — Buy Fake IDs from $65
          </h1>
          <p className="text-sm text-gray-600 mb-8">
            Select your state, fill in your details, and receive your{' '}
            <Link href="/product-info" className="text-yellow-green hover:underline">scannable fake ID</Link> in as fast as 9 days.
            Not sure which state? <Link href="/product-list" className="text-yellow-green hover:underline">Browse all fake IDs</Link> or{' '}
            <Link href="/faq" className="text-yellow-green hover:underline">check the FAQ</Link>.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            ...
            <div className="space-y-4">
                ...
                <div className="bg-gray-100 rounded-lg aspect-[3.375/2.125] flex items-center justify-center overflow-hidden relative">
                  <div className="w-full h-full">
                    <img 
                      ...
                      alt={`${formData.product} fake ID preview`}
              ...
              <div className="grid grid-cols-3 gap-4">
                <div 
                  onClick={() => setMainProductImage(PRODUCT_IMAGES[formData.product] || '/images/ordertemp.png')}
                ...
                >
                  <div className="bg-gray-100 rounded aspect-[3.375/2.125] flex items-center justify-center overflow-hidden relative">
                    <div className="w-full h-full">
                      <img 
                        src={PRODUCT_IMAGES[formData.product] || '/images/ordertemp.png'}
                        alt="Front view" 
                        className="w-full h-full object-contain"
                        onError={(e) => {
                          e.currentTarget.style.display = 'none';
          ...
          <form onSubmit={handleFormSubmit} className="bg-white rounded-lg shadow-lg p-6 sm:p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
              ...
              <div className="md:col-span-2 flex gap-2">
                <div className="w-32 px-4 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-700 text-sm flex items-center">
                  WhatsApp
                </div>
                <input
                  type="text"
                  ...
                  placeholder="Enter your WhatsApp number (e.g. +19124844702)"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
              ...
              <div className="md:col-span-2">
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-green focus:border-transparent"
                  placeholder="your@email.com — we'll send your order confirmation here"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-1.5 sm:space-y-2 text-gray-400 text-xs sm:text-sm">
                ...
                <div className="flex space-x-3 mt-4">
                  ...
                  <a href="mailto:idplugsource@gmail.com" className="w-10 h-10 sm:w-12 sm:h-12 bg-orange-500 rounded-lg flex items-center justify-center hover:bg-orange-600 transition">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      {/* Floating Back-to-top Button (moved to bottom-left to avoid WhatsApp widget) */}
