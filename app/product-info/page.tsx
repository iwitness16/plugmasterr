...
export const metadata: Metadata = {
  title: 'Scannable Fake ID — Features, Shipping & Product Info | IDPlugSource',
  description:
  ...
  openGraph: {
    ...
    url: 'https://IDPlugSource.com/product-info',
    siteName: 'IDPlugSource',
    images: [{ url: 'https://IDPlugSource.com/images/idfront.jpg', width: 1200, height: 630, alt: 'Scannable Fake ID Product Info' }],
    type: 'website',
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://IDPlugSource.com/product-info',
  },
};
