...
interface Product {
  id: string;
  name: string;
  category: 'USA ID' | 'CANADA ID' | 'SSN';
  price: number;
  image: string;
}

// All products based on screenshots
const allProducts: Product[] = [
  // USA ID - Regular States
  { id: 'alabama', name: 'Alabama', category: 'USA ID', price: 100, image: getRandomImage(0) },
  { id: 'arizona', name: 'Arizona', category: 'USA ID', price: 100, image: getRandomImage(1) },
  { id: 'california', name: 'California', category: 'USA ID', price: 100, image: getRandomImage(2) },
  { id: 'california-cm1', name: 'California CM1', category: 'USA ID', price: 100, image: getRandomImage(3) },
  { id: 'connecticut', name: 'Connecticut', category: 'USA ID', price: 100, image: getRandomImage(4) },
  { id: 'delaware', name: 'Delaware', category: 'USA ID', price: 100, image: getRandomImage(5) },
  { id: 'florida', name: 'Florida', category: 'USA ID', price: 100, image: getRandomImage(6) },
  { id: 'florida-motorcycle', name: 'Florida Motorcycle', category: 'USA ID', price: 100, image: getRandomImage(7) },
  { id: 'georgia', name: 'Georgia', category: 'USA ID', price: 100, image: getRandomImage(0) },
  { id: 'illinois', name: 'Illinois', category: 'USA ID', price: 100, image: getRandomImage(1) },
  { id: 'indiana', name: 'Indiana', category: 'USA ID', price: 100, image: getRandomImage(2) },
  { id: 'kansas', name: 'Kansas', category: 'USA ID', price: 100, image: getRandomImage(3) },
  { id: 'maryland', name: 'Maryland', category: 'USA ID', price: 100, image: getRandomImage(4) },
  { id: 'massachusetts', name: 'Massachusetts', category: 'USA ID', price: 100, image: getRandomImage(5) },
  { id: 'michigan', name: 'Michigan', category: 'USA ID', price: 100, image: getRandomImage(6) },
  { id: 'minnesota', name: 'Minnesota', category: 'USA ID', price: 100, image: getRandomImage(7) },
  { id: 'mississippi', name: 'Mississippi', category: 'USA ID', price: 100, image: getRandomImage(0) },
  { id: 'missouri', name: 'Missouri', category: 'USA ID', price: 100, image: getRandomImage(1) },
  { id: 'nebraska', name: 'Nebraska', category: 'USA ID', price: 100, image: getRandomImage(2) },
  { id: 'nevada', name: 'Nevada', category: 'USA ID', price: 100, image: getRandomImage(3) },
  { id: 'new-jersey', name: 'New Jersey', category: 'USA ID', price: 100, image: getRandomImage(4) },
  { id: 'new-york', name: 'New York Old Verison', category: 'USA ID', price: 100, image: getRandomImage(5) },
  { id: 'north-carolina', name: 'North Carolina', category: 'USA ID', price: 100, image: getRandomImage(6) },
  { id: 'ohio', name: 'Ohio', category: 'USA ID', price: 100, image: getRandomImage(7) },
  { id: 'pennsylvania', name: 'Pennsylvania', category: 'USA ID', price: 100, image: getRandomImage(0) },
  { id: 'rhode-island', name: 'Rhode Island', category: 'USA ID', price: 100, image: getRandomImage(1) },
  { id: 'south-carolina', name: 'South Carolina', category: 'USA ID', price: 100, image: getRandomImage(2) },
  { id: 'texas', name: 'Texas', category: 'USA ID', price: 100, image: getRandomImage(3) },
  { id: 'utah', name: 'Utah', category: 'USA ID', price: 100, image: getRandomImage(4) },
  { id: 'virginia', name: 'Virginia', category: 'USA ID', price: 100, image: getRandomImage(5) },
  { id: 'washington', name: 'Washington', category: 'USA ID', price: 100, image: getRandomImage(6) },
  
  // USA ID - CDL (Commercial Driver License)
  { id: 'california-cdl', name: 'California CDL', category: 'USA ID', price: 200, image: getRandomImage(7) },
  { id: 'illinois-cdl', name: 'Illinois CDL', category: 'USA ID', price: 200, image: getRandomImage(0) },
  { id: 'new-york-cdl', name: 'New York CDL', category: 'USA ID', price: 200, image: getRandomImage(1) },
  { id: 'ohio-cdl', name: 'Ohio CDL', category: 'USA ID', price: 200, image: getRandomImage(2) },
  { id: 'pennsylvania-cdl', name: 'Pennsylvania CDL', category: 'USA ID', price: 200, image: getRandomImage(3) },
  { id: 'texas-cdl', name: 'Texas CDL', category: 'USA ID', price: 200, image: getRandomImage(4) },
  
  // CANADA ID
  { id: 'british-columbia', name: 'British Columbia', category: 'CANADA ID', price: 100, image: getRandomImage(5) },
  { id: 'ontario', name: 'Ontario', category: 'CANADA ID', price: 100, image: getRandomImage(6) },
  { id: 'quebec', name: 'Quebec', category: 'CANADA ID', price: 100, image: getRandomImage(7) },
  
  // SSN
  { id: 'ssn', name: 'SSN', category: 'SSN', price: 100, image: getRandomImage(0) },
];
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden lg:flex space-x-8">
              ...
              <Link href="/product-list" className="text-yellow-green hover:text-yellow-green transition text-sm border-b-2 border-yellow-green pb-1">PRODUCT LIST</Link>
          ...
          <div className="lg:hidden overflow-x-auto pb-3 hide-scrollbar">
            <div className="flex space-x-6 min-w-max">
              ...
              <Link href="/product-list" className="text-yellow-green text-sm whitespace-nowrap border-b-2 border-yellow-green pb-1">PRODUCT LIST</Link>
