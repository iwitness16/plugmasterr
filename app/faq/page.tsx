    ...
    <div className="min-h-screen bg-white font-sans">
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden lg:flex space-x-8">
              ...
              <Link href="#" className="hover:text-yellow-green transition text-sm text-gray-300">EVALUATE</Link>
              <Link href="/faq" className="text-yellow-green hover:text-yellow-green transition text-sm border-b-2 border-yellow-green pb-1">FAQ</Link>
          ...
          <div className="lg:hidden overflow-x-auto pb-3 hide-scrollbar">
            <div className="flex space-x-6 min-w-max">
              ...
              <Link href="/faq" className="text-yellow-green text-sm whitespace-nowrap border-b-2 border-yellow-green pb-1">FAQ</Link>
      ...
      <div className="pt-32 sm:pt-40 lg:pt-48 pb-12 px-4 sm:px-6 lg:px-8 border-t border-white">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold text-black mb-8 sm:mb-12 text-center">
          ...
          <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-200">
            <p className="text-gray-700 text-sm sm:text-base mb-2">
              <span className="font-semibold">WhatsApp:</span> +852 6705 2477
            </p>
            <p className="text-gray-700 text-sm sm:text-base">
              <span className="font-semibold">Telegram:</span> @idcardmoss
            </p>
          </div>
        </div>
      </div>
