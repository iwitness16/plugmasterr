        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-200">
            ...
            <p className="text-gray-700 text-sm sm:text-base mb-2">
              <span className="font-semibold">WhatsApp (orders &amp; support):</span> +1 (912) 484-4702
            </p>
            <p className="text-gray-700 text-sm sm:text-base mb-4">
              <span className="font-semibold">Telegram:</span> @fakeidplugsource10
            </p>
      ...
      <footer className="bg-black py-12 sm:py-16 px-4 sm:px-6 lg:px-8 border-t border-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center pt-6 sm:pt-8 mt-8 sm:mt-12 border-t border-gray-800">
            <p className="text-gray-500 text-xs sm:text-sm">Copyright {'\u00A9'} 2026, IDPlugSourceplug, All Rights Reserved</p>
          </div>
        </div>
      </footer>
