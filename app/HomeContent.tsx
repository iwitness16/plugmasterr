          ...
          <div className="flex flex-col items-center gap-6 sm:gap-8">
            ...
            <div className="w-full">
              <img
                ...
                alt="IDPlugSource - Best Fake ID Maker"
                title="IDPlugSource - Premium Scannable Fake IDs"
                width={1200}
                height={600}
                fetchPriority="high"
                loading="eager"
                decoding="sync"
                className="w-full h-auto max-h-[45vh] sm:max-h-[55vh] lg:max-h-[65vh] object-cover object-center rounded-lg"
              />
            </div>
            {/* Stats Row */}
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
              <div className="flex items-center space-x-3">
                <div className="flex -space-x-2">
                  <img src="/images/man1.jpg" alt="IDPlugSource customer 1" width={28} height={28} loading="lazy" className="w-6 h-6 sm:w-7 sm:h-7 rounded-full object-cover border-2 border-gray-900" />
                  <img src="/images/man2.jpg" alt="IDPlugSource customer 2" width={28} height={28} loading="lazy" className="w-6 h-6 sm:w-7 sm:h-7 rounded-full object-cover border-2 border-gray-900" />
                  <img src="/images/man3.jpg" alt="IDPlugSource customer 3" width={28} height={28} loading="lazy" className="w-6 h-6 sm:w-7 sm:h-7 rounded-full object-cover border-2 border-gray-900" />
                  <img src="/images/man4.jpg" alt="IDPlugSource customer 4" width={28} height={28} loading="lazy" className="w-6 h-6 sm:w-7 sm:h-7 rounded-full object-cover border-2 border-gray-900" />
                </div>
                <div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-12">
            <div className="relative">
              <div className="flex items-center justify-center h-64">
                <img src="/images/ordertemp.png" alt="Best fake ID card - scannable UV hologram fake driver license" title="Best Fake ID Card - IDPlugSource" width={338} height={213} loading="lazy" className="max-w-full max-h-full object-contain" />
              </div>
            </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-12">
            <div className="relative">
              <div className="flex items-center justify-center">
                <img src="/images/delivery.jpg" alt="Best fake ID fast delivery worldwide - IDPlugSource shipping" title="Fake ID Fast Delivery" width={500} height={380} loading="lazy" className="w-full h-auto max-h-96 object-contain" />
              </div>
            </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center mb-8">
            <div className="relative">
              <div className="flex items-center justify-center">
                <img src="/images/cards.jpg" alt="IDPlugSource - best fake ID cards collection for all US states" title="Best Fake ID Cards - IDPlugSource" width={500} height={380} loading="lazy" className="w-full h-auto max-h-96 object-contain" />
              </div>
            </div>
            <div className="space-y-4">
              <p className="text-xs sm:text-sm text-gray-300">
                IDPlugSource is the industry-leading Fake ID card production website. The website provides you with high-quality, legal, scannable Fake ID cards from all Canadian and US states, using high-tech printing technology to ensure that each card passes all security tests.
              </p>
              <p className="text-xs sm:text-sm text-gray-300">
            ...
            <div>
              ...
              <div className="space-y-1 sm:space-y-1.5 text-gray-400 text-xs">
                ...
                <div className="flex space-x-3 mt-4">
                  <a href="https://wa.me/19124844702" target="_blank" rel="noopener noreferrer" aria-label="Contact us on WhatsApp" className="w-8 h-8 sm:w-10 sm:h-10 bg-green-500 rounded-lg flex items-center justify-center hover:bg-green-600 transition">
                  ...
                  <a href="https://t.me/fakeidplugsource10" target="_blank" rel="noopener noreferrer" aria-label="Contact us on Telegram" className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-500 rounded-lg flex items-center justify-center hover:bg-blue-600 transition">
                  ...
                  <a href="mailto:idplugsource@gmail.com" aria-label="Send us an email" className="w-10 h-10 sm:w-12 sm:h-12 bg-orange-500 rounded-lg flex items-center justify-center hover:bg-orange-600 transition">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
