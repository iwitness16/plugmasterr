        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8 sm:mb-12">
            <h1 className="text-2xl sm:text-3xl font-display font-bold text-gray-900 mb-3">
              Contact Us — Fake ID for Sale, Inquiries &amp; Support
            </h1>
            <p className="text-gray-700 text-base sm:text-lg mb-4 sm:mb-6">
              Ready to buy a <Link href="/product-list" className="text-green-600 font-semibold hover:underline">fake ID for sale</Link>? Contact us on WhatsApp or Telegram.
              All orders, payments and updates are handled there for faster and more secure processing.
            </p>
            <p className="text-gray-500 text-sm mb-6">
              Have questions first? Check our <Link href="/faq" className="text-blue-600 hover:underline">FAQ</Link> or{' '}
              <Link href="/product-info" className="text-blue-600 hover:underline">product info</Link>.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 max-w-3xl mx-auto">
            ...
            {/* Telegram Button */}
            <a 
              href="https://t.me/fakeidplugsource10" 
              target="_blank" 
              rel="noopener noreferrer"
