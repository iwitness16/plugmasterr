...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://IDPlugSource.com/',
    siteName: 'IDPlugSource',
    images: [{ url: 'https://IDPlugSource.com/images/idfront.jpg', width: 1200, height: 630, alt: 'Best Fake ID - IDPlugSource' }],
    type: 'website',
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://IDPlugSource.com/',
  },
};
