        ...
        <div className="max-w-xl mx-auto text-center">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-sm sm:text-base">
              Your order has been received and we will process it as soon as possible.
            </p>
          </div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 sm:p-8 mb-8">
            <p className="text-gray-700 text-sm sm:text-base mb-4">
              Send your order details via WhatsApp to enable faster processing. You can review and send the message in the chat.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 bg-white border-2 border-gray-300 text-gray-700 px-6 py-3 rounded-lg font-semibold text-sm hover:bg-gray-50 hover:border-gray-400 transition"
              >
                Continue without WhatsApp
              </button>
            </div>
            <p className="text-gray-500 text-xs mt-4">
              &quot;Continue without WhatsApp&quot; will take you back to the home page.
            </p>
          </div>
